// Service Worker for TODO App with ElectricSQL
const CACHE_NAME = 'todo-app-electricsql-v1.0';
const urlsToCache = [
    './',
    './index.html',
    './main.js',
...
self.addEventListener('fetch', function(event) {
    ...
    // Skip WebSocket connections and Vite dev requests
        ...
        caches.match(event.request)
            .then(function(response) {
                ...
                return fetch(event.request).then(function(response) {
                    ...
                    // Don't cache HEAD requests or non-GET requests
